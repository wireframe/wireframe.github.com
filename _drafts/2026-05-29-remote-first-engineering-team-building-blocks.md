...
**Remote-first doesn't mean remote-only.** In-person working sessions are an incredibly high-leverage investment for specific kinds of work. Quarterly planning brings the team into alignment on strategy. Team off-sites are concentrated time for design sprints, product discovery, and the kind of work that benefits most from co-location (and usually a whiteboard). Code ships fine over a wire; figuring out what to build doesn't.

**The office is the worst place to do deep work.** Focus is the asset everything else converts into output, and modern offices are structurally hostile to it. Open floor plans actually reduce face-to-face interaction (Bernstein & Turban, 2018) and claustrophobic phone booths are a draining and demoralizing employee experience. Endless "got a sec?" interruptions destroy concentration. Remote-first inverts the default, letting you protect uninterrupted blocks of focus in a way offices structurally can't, and boost productivity nearly 10% (Bloom's Stanford study).
