...
**Build the scoreboard.** Remote breaks the room-reading instincts that surface team health in an office. Tense standups, hallway grumbling, who's eating lunch alone. All invisible. You have to instrument the team explicitly. Psychological safety surveys, Developer eXperience metrics, SPACE and DORA frameworks measure the team. Platform quality scorecards measure the systems. I've written about [scoring platforms across security, maintainability, and operational dimensions](/2024/03/scaling-platform-quality.html). Project Aristotle confirmed psychological safety is the top team performance factor; remote just means you can't read it off the room. Where you shine the light, the work follows.

**Cultural amplifiers compound.** Lightweight systems that reinforce the behaviors you want to see create a snowball effect. A Slack channel for shoutouts. A monthly recognition callout. None of these cost much. They make great work visible, and new team members copy what they see. Peers are the most effective and most underused source of reinforcement (Daniels). Managers can't observe enough behavior to be the primary signal, and remote widens the gap. Build the surface that lets peers do the work.
