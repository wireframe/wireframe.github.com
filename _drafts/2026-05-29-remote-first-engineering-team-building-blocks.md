...
Remote-first lets you fish the global pond instead of the thirty-mile one. Engineers who were previously off-limits because of where they happened to live become hireable, and the candidate pool grows by roughly an order of magnitude in most roles. The practical limit isn't geography anymore, it's timezone overlap. Flexible hours are a perk; core hours are a requirement. Screening is still hard, probably harder, since you're now competing globally for the top of every market at once. The constraint becomes your hiring bar, not your zip code.
...
Attention is harder to hold remote. In an office, social pressure and physical separation create friction against drifting. At home there's none, and every reinforcing alternative to the work is an arm's length away: phone, family, fridge, the dog. Managers can't rely on the environment to keep people focused. They have to pull attention toward the work themselves, through visible recognition and fast feedback, since the room isn't doing any of that work for them.

Which is why remote-first isn't for everyone, and pretending otherwise is how you end up with the wrong hires. Some people do their best work in a room with other humans, with the ambient pressure and the hallway conversations. That's a real preference, not a flaw. The fix is explicit screening for remote-fit: name it in the job post, ask about it directly in the interview, describe what an average Wednesday actually looks like alone in a home office, and let candidates self-select. Self-selection is the cheapest filter you have, and most companies don't use it.
