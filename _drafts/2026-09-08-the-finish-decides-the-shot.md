...
Most experiments are small, and small results get cleared and forgotten. When we audited our own flags at the end of a platform year, several were over a year old, and stale flags became [a quantitative measure of health on every system's scorecard]({% post_url 2024-03-22-scaling-platform-quality %}). The standard advice about experimenting well makes this worse: keep failures small and cheap. **So the experiments most worth running are exactly the ones nothing will ever demand a finish for.**
...
Every team already writes down what "done" means, and the finish is not in the definition. The Scrum Guide defines Done as "a formal description of the state of the Increment when it meets the [quality measures required for the product](https://scrumguides.org/scrum-guide.html)." Quality measures on the thing built. Nothing about the business outcome, nothing about removal. The finish gets treated like a non-functional requirement: assumed by everyone, written into nobody's scope. Engineering is the profession of creating *and* reducing complexity, so **done is when the system's complexity is back in line with what the business actually needs**, whichever way the answer came out. Go open your team's definition of done and count how many of its lines describe the thing you built, and how many describe the state you're leaving the system in.
