...
- [ ] Task 1.1: Create the script skeleton with usage and argument handling
  - File: `bin/social` (new)
...
- [ ] Task 1.2: Validate the post path
  - File: `bin/social`
...
- [ ] Task 1.3: Derive the live URL from the filename and `_config.yml`
...
- [ ] Task 1.4: Read the `social:` folded scalar
  - File: `bin/social`
...
- [ ] Task 1.5: Assemble the block and count characters
  - File: `bin/social`
...
- [ ] Task 1.7: Revert the fixture and commit
...
- [ ] Task 2.1: Create the skill file with frontmatter
...
- [ ] Task 2.2: Write the inputs and when-to-use section
...
- [ ] Task 2.3: Write the candidate-generation step
  - File: `.claude/skills/sharing-on-social/SKILL.md`
  - Change: read the published post first, then offer **three candidates taking genuinely different angles** — a claim, a concrete scene, a question — following the house pattern at `.claude/skills/writing-a-blog-post/SKILL.md:33`, including its escalation: if several rounds fail, ask what dimension is wrong rather than generating more. State the budget from D5: the whole assembled string stays at or under 280 characters counting the URL at its literal length (39 + slug length on this site, so 46-75), leaving roughly 205-234 characters of prose. Per D4, one text that pastes identically into both platforms — no per-platform variants, no hashtags, no @-mentions.
...
- [ ] Task 2.4: Write the candidate display format
  - File: `.claude/skills/sharing-on-social/SKILL.md`
...
- [ ] Task 2.5: Write the front-matter write step
  - File: `.claude/skills/sharing-on-social/SKILL.md`
...
- [ ] Task 2.6: Write the handoff to `bin/social`
  - File: `.claude/skills/sharing-on-social/SKILL.md`
...
- [ ] Task 2.7: Add the pointer line to the blog skill
...
- [ ] Task 2.8: End-to-end run, with leakage and preview checks
...
- [ ] Task 3.1: Add the applicable-subset checklist to the new skill
  - File: `.claude/skills/sharing-on-social/SKILL.md`
...
- [ ] Task 3.2: Red/green the guardrail
...
- [ ] Task 4.1: Add the social step to the Workflow section
...
- [ ] Task 4.2: Document the `social:` key in the front matter template
