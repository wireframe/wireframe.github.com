...
- **The Ranter (2003–2007): curious mind, defended self.**
  - Enticing HIGH, Alive HIGH, Safe LOW, Good MIXED. Tech is art worth devoting a life to (`2004-03-20-why-opensource-exists.md`), and individual action matters ("change the world, right here, right now," `2005-09-27`). But the human world is adversarial — sorted into people who "get it" (`2005-10-10-real-world.md`) vs. "mindless drones" (`2006-03-20-curse-of-passion.md`), full of enemies (JSP, vendors, management) to be fought. Low Safe.
